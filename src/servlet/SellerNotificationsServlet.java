...
import servlet.pojo.NotificationDTO;
...
public class SellerNotificationsServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<NotificationDTO> allNotifications2 = allNotifications.stream().map(NotificationDTO::new).collect(Collectors.toList());
        String reply = "";
        Gson gson = new Gson();
        JsonElement temp = gson.toJsonTree(allNotifications2);
